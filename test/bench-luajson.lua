...
--- File        : test/bench-luajson.lua                                    ---
--- Description : luajson test: random tables, speed cklocked               ---
--- Version     : 0.3.0 / alpha                                             ---
...
-------------------------------------------------------------------------------
---                                                                         ---
---  This tests only the luajson C library (not Fleece):                    ---
---                                                                         ---
---  LuaJSON 1.1: (aka luajsonlib) http://luaforge.net/projects/luajsonlib/ ---
---                                                                         ---
---  Use: lua test/bench-luajson.lua                                        ---
---                                                                         ---
-------------------------------------------------------------------------------

print("Fleece Benchmarks: LuaJSON C lib")
print("=========================================================")
...
print("LUAJSON CAN CRASH THIS TEST. SEE BENCH3a & BENCH3b.")
...
local function measure1(prepP, prepare, prompt1, action1)
...
measure1("t[i]=randstr(i)",
		function(i) t[i] = randstr(i) end,
		"luajson.stringify(t)",
		function(i) return luajson.stringify(t) end
		)		
		
measure1("t[randstr(i)]=randstr(i)",
