...
--- File        : test/bench7c.lua                                          ---
--- Description : Fleece vs LuaJSON C lib: random escape chars, clocked     ---
--- Version     : 0.3.0 / alpha                                             ---
...
---  hd6010@eonblast.com                                                    ---
---                                                                         ---
---  This runs Fleece vs the LuaJSON C library, for speedier checking of    ---
---  absolute performance and relative performance, with Fleece' diverse    ---
---  escape settings switched on or off.                                    ---
---                                                                         ---
---  Use: lua test/bench7c.lua                                              ---
---  Or:  make bench7c                                                      ---
---                                                                         ---
-------------------------------------------------------------------------------

print("Fleece Benchmarks vs LuaJSON C lib for ESCAPE characters")
print("========================================================")
...
print("and also built LuaJSON using 'make <PLATFORM>-test',")
...
local function measureX(prepP, prepare, prompt1, action1,  
  ...
  t = nil
	...
	submeasure(prepP, prepare, prompt3, action3, first)
	submeasure(prepP, prepare, prompt4, action4, first)
	submeasure(prepP, prepare, prompt5, action5, first)
	submeasure(prepP, prepare, prompt6, action6, first)
	submeasure(prepP, prepare, prompt7, action7, first)
