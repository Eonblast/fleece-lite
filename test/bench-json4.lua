...
--- File        : test/bench-json4.lua                                      ---
--- Description : JSON4 test: random tables, clocked                        ---
--- Version     : 0.2.4 / alpha                                             ---
...
-------------------------------------------------------------------------------
---                                                                         ---
---  This tests JSON4 only                                                  ---
---                                                                         ---
---  JSON4 0.9.50: (aka JSON4Lua, JSON for Lua) http://json.luaforge.net/   ---
---                                                                         ---
---  Use: lua test/bench-json4.lua                                          ---
---                                                                         ---
-------------------------------------------------------------------------------

print("Fleece Benchmarks: JSON4 only (native Lua JSON conversion)")
print("============================================================")
print("A couple of random tables are created and speed is clocked.")
print("You should start this from the fleece root directory.")
print("JSON4 is in etc/json4.")
