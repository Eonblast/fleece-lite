...
--- File        : test/bench5a.lua                                          ---
--- Description : Fleece only: random tables, speed cklocked, very long     ---
--- Version     : 0.3.0 / alpha                                             ---
...
---                                                                         ---
---  Use: lua test/bench5a.lua                                              ---
---                                                                         ---
-------------------------------------------------------------------------------

print("Fleece Benchmarks - Fleece Long Running Crash Test")
print("=========================================================")
