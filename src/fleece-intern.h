...
*** ----------------------------------------------------------------------- ***
***                                                                         ***
***      Most of the parameter related definitions are not used yet.        ***
***      ===========================================================        ***
***                                                                         ***
***  Most relevant are FLEECE_DEFAULT_LUCKY_BUF & FLEECE_DEFAULT_PARTS_BUF  ***
***                                                                         ***
*** ----------------------------------------------------------------------- ***
***                                                                         ***
...
/*                        parked here, mostly not used                        */
/*                        move to config.h on employing                       */
...
***                                                                         ***
\*****************************************************************************/
/* used as placeholder strings when such special types are encountered       */
